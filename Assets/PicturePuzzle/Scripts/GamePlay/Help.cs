/***************************************************************************************
 * HANDLES THE INGAME HELP. THIS SCRIPT WILL GET ACTIVATED ONLY ONCE IN THE GAMEPLAY.
 * THERE IS TOTAL 3 STEPS OF THE HELP.
 ***************************************************************************************/
...
public class Help : MonoBehaviour {
	[SerializeField] GameObject firstInputChar;
	[SerializeField] GameObject helpContent_1;
	[SerializeField] GameObject helpContent_2;
	[SerializeField] GameObject helpContent_3;
	...
	public void ShowHelp(int helpStep) {
		if(helpStep == 1) {
			...
			firstAnswerChar = GamePlay.Instance.answerPanel.transform.GetChild(0).gameObject;
            ...
            transform.SetSiblingIndex(GamePlay.Instance.answerPanel.transform.parent.GetSiblingIndex());
