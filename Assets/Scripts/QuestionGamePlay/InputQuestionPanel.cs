...
public class InputQuestionPanel : MonoBehaviour
{
    [SerializeField]
    List<InputChar> puzzleCharaterButtons = new List<InputChar>();
    [SerializeField]
    Color textDefaultColor;
    [SerializeField]
    Color textHighlightColor;
    [SerializeField]
    UnityEngine.UI.Button btnRemoveLetters;
    ...
    {
        for (int index = 0; index < QuestionGamePlay.thisLevel.answer.Length; index++)
        {
    ...
    void RevealLetter()
    {
        if (!QuestionGamePlay.Instance.answerPanel.isAnswerPanelFull())
        {
            List<AnswerChar> allEmptyAnswerChars = QuestionGamePlay.Instance.answerPanel.GetAllEmptyChar();
            ...
            if (randomAnswerChar != null)
            {
                ...
                if (inputChar != null)
                {
                    ...
                    if (QuestionGamePlay.Instance.answerPanel.isAnswerPanelFull())
                    {
                        QuestionGamePlay.Instance.VerifyAnswer();
                    }
                }
            }
        }
        ...
        {
            List<AnswerChar> allWrongAnswerChars = QuestionGamePlay.Instance.answerPanel.GetAllWrongAnswerInputs();
